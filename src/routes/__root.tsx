...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Fine Dining — LuxePOS" },
      ...
      { property: "og:image", content: "/fine-dining-icon.png" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:image", content: "/fine-dining-icon.png" },
    ],
    links: [
      { rel: "icon", type: "image/png", sizes: "32x32 48x48 192x192", href: "/fine-dining-icon.png" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/fine-dining-icon.png" },
